...
#[derive(Debug)]
pub struct OrionPrimeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OrionPrimeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OrionPrime processing");
    
    let mut processor = OrionPrimeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OrionPrimeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OrionPrimeProcessor::new(false);
